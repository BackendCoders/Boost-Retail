...
import plusIcon from '../../../assets/blueicons/plus.svg';
import editIcon from '../../../assets/blueicons/edit.svg';
import deleteIcon from '../../../assets/blueicons/delete.svg';
import downArrow from '../../../assets/svgIcons/Down-Thin.svg';
...
const CategoryTree = () => {
  ...
  <div key={cat.id} className="mb-1">
    ...
    >
      ...
      {/* Category Text */}
      <span className={`font-medium ${cat.count === 0 ? 'text-red-500' : 'text-gray-700'}`}>
        {cat.name}
      </span>
      ...
      <div className="flex items-center gap-2 ml-2">
        <img src={plusIcon} alt="Add" className="w-4 h-4 cursor-pointer hover:scale-110" />
        <img src={editIcon} alt="Edit" className="w-4 h-4 cursor-pointer hover:scale-110" />
        <img src={deleteIcon} alt="Delete" className="w-4 h-4 cursor-pointer hover:scale-110" />
      </div>
    </div>
