...
import { supplierFeedEndpoints } from '../api';
import {
	// handleDeleteReq,
	handleGetReq,
	// handlePostReq,
...
const { GET_SUPPLIER_FEEDS } = supplierFeedEndpoints;
...
export async function getSupplierFeeds() {
	const response = await handleGetReq(GET_SUPPLIER_FEEDS);
